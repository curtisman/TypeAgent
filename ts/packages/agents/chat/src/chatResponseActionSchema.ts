...
// Use this action to answer the user request when all the information is available in context.  Do not invent information or make up facts.
export interface AnswerRequestAction {
    actionName: "answerRequest";
    parameters: {
        // the original request from the user
        originalRequest: string;
        // The generated answer that is based solely on information available.
